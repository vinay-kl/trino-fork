            ...
            ConnectorAccessControl accessControl)
    {
        ...
        try (UncheckedCloseable ignore = () -> deltaLakeMetadata.cleanupQuery(session)) {
            ...
            return TableFunctionAnalysis.builder()
                    .handle(new TableChangesTableFunctionHandle(schemaTableName, firstReadVersion, tableHandle.getReadVersion(), tableHandle.getLocation(), columnHandles, tableHandle.toCredentialsHandle()))
